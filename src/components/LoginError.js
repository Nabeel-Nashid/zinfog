    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-200 to-cyan-200">
      <div className="absolute top-[91px] left-[25%] w-[50%] h-[80%] rounded-[45px] bg-white drop-shadow-2xl">
        ...
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-red-700 underline-offset-1 mt-2">Wrong Credentials! your email Id or password entered is wrong</h1>
          ...
          I hereby agree and accept the <a href=""><span className="text-[#2a2a9e]">Terms of service</span></a> and <a href=""><span className="text-[#2a2a9e]">Privacy policy</span></a>
            </h1>
